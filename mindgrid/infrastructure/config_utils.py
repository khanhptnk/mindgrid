...
def check(config: Dict):
    ...
    assert (
        set(["preference", "skill", "env"]) <= true_reps
    ), f"Human mental representations are missing {true_reps}"
    assert (
        set(["preference", "skill", "env"]) <= false_reps
    ), f"Human mental representations are missing {false_reps}"
